...
f_02 = np.load('face_02.npy').reshape((20, 50*50*3))	# Uttam
f_03 = np.load('face_03.npy').reshape((20, 50*50*3))	# Anurag
...
labels[:20, :] = 0.0	# first 20 for Ankit (0)
labels[20:40, :] = 1.0	# next 20 for Uttam(1)
labels[40:, :] = 2.0	# last 20 for Anurag (2)
